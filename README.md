...
| 김성욱 | 실사용 환경에 가까운 검증을 위해 “ngrok” 을 활용하여 외부 접속 환경을 구축했습니다. 덕분에 장소와 기기에 구애받지 않고 이동 중에도 테스트를 진행할 수 있었고, 지인들에게 손쉽게 테스트를 요청하여 다양한 사용 패턴과 예외 상황 데이터를 빠르게 수집했습니다. 덕분에 챗봇의 대응 능력을 개선하는 데 큰 도움이 되었습니다.
또한, 팀원 모두 각자의 역할에 책임감을 갖고 임했으며, 적극적인 소통 덕에 견고한 협업 구조를 다질 수 있었습니다. 함께 일하는 방식과 커뮤니케이션의 중요성을 다시금 깨달은 감사한 시간이었습니다. |
